...
class Maestrano_Account_UserIntegrationTest extends PHPUnit_Framework_TestCase
{
  ...
  */
  ...
  public function testRetrieveAllUsers() {
    $mno_userList = Maestrano_Account_User::all();
    ...
    $this->assertEquals('maestrano',$mno_user->getPreset());
